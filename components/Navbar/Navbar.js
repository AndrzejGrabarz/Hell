...
function Navbar() {
  return (
    <div className="flex flex-col sm:flex-col md:flex-col lg:flex-col xl:flex-col 2xl:flex-row items-center  font-barlow italic w-full mt-12 text-[#000206]">
      <ul className="flex flex-col sm:flex-row sm:justify-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-3xl text-center w-full font-test">
        <li>
