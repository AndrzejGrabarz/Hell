    ...
    <main className="flex min-h-screen w-full flex-col items-center ">
      ...
      <div className="flex flex-col items-center mt-16 mb-12 w-full">
        <div className="sm:flex sm:flex-row mt">
          ...
          <div className=" sm:flex sm:text-center sm:flex-col sm:w-[700px] sm:h-full sm:p-8">
            <div className="text-3xl sm:text-4xl m-8 font-RedHatItalic font-medium italic">O mnie</div>
            <div className="text-lg sm:text-2xl font-RedHatItalic font-light mx-4 sm:mx-0">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center mt-12 mb-12 w-full">
