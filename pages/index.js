...
export default function Home() {
  return (
    <main className="flex min-h-screen w-full flex-col items-center ">
      ...
      <div className="flex self-start text-4xl m-12 sm:text-7xl sm:mx-16 sm:my-32 font-RedHatItalic  italic ">Lampy</div>
      ...
      <div className="flex self-start text-4xl m-12 sm:text-7xl sm:mx-16 sm:my-32 font-RedHatItalic  italic">Wazony</div>
      <div className="flex justify-center flex-row mt-12 flex-wrap">
        <ImageBox lampOn="KluczOff" lampOff="KluczOn" lampa="Klucz" />
        <ImageBox lampOn="LotosOff" lampOff="LotosOn" lampa="Lotos" />
        <ImageBox lampOn="PasekOff" lampOff="PasekOn" lampa="Pasek" />
      </div>
      <div className="flex self-start text-4xl m-12 sm:text-7xl sm:mx-16 sm:my-32 font-RedHatItalic  italic">Patery</div>
